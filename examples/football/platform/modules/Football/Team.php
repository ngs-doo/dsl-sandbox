...
require_once __DIR__.'/TeamJsonConverter.php';
 ...
 * @version 0.9.9 beta
 */
class Team extends \NGS\Patterns\AggregateRoot implements \IteratorAggregate
{
    protected $URI;
    protected $ID;
    protected $name;
    ...
    /**
     * Constructs object using a key-property array or instance of class "Football\Team"
     *
     * @param array|void $data key-property array or instance of class "Football\Team" or pass void to provide all fields with defaults
     */
    ...
    private function fromArray(array $data)
    {
        ...
        if (count($data) !== 0 && \NGS\Utils::WarningsAsErrors())
            throw new \InvalidArgumentException('Superflous array keys found in "Football\Team" constructor: '.implode(', ', array_keys($data)));
    }
...
// ============================================================================
    ...
    public function __get($name)
    {
        ...
        throw new \InvalidArgumentException('Property "'.$name.'" in class "Football\Team" does not exist and could not be retrieved!');
    }
...
// ============================================================================
    ...
    public function __set($name, $value)
    {
        if(in_array($name, self::$_read_only_properties, true))
            throw new \LogicException('Property "'.$name.'" in "Football\Team" cannot be set, because it is read-only!');
        if ($name === 'name')
            return $this->setName($value); // a string
        throw new \InvalidArgumentException('Property "'.$name.'" in class "Football\Team" does not exist and could not be set!');
    }
    ...
    /**
     * Create or update Football\Team instance (server call)
     *
    ...
    private function updateWithAnother(\Football\Team $result)
    {
        $this->URI = $result->URI;
    ...
    /**
     * Get array of Snapshot objects for history changes
     *
     * @param string or array of URIs
     *
     * @return array of \NGS\Client\Snapshot with value property as Football\Team
     */
    public static function getHistory($uri)
    {
        return \NGS\Client\ReportingProxy::instance()->getHistory('\Football\Team', $uri);
    }

    public function toJson()
    {
        return \Football\TeamJsonConverter::toJson($this);
    }

    public static function fromJson($item)
    {
        return \Football\TeamJsonConverter::fromJson($item);
    }

    public function __toString()
    {
        return 'Football\Team'.$this->toJson();
    }

    public function __clone()
    {
        return \Football\TeamArrayConverter::fromArray(\Football\TeamArrayConverter::toArray($this));
    }

    public function toArray()
    {
        return \Football\TeamArrayConverter::toArray($this);
    }
    ...
    {
        return new \ArrayIterator(\Football\TeamArrayConverter::toArray($this));
    }
}