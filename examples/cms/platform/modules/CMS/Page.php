 ...
 * @version 0.9.9 beta
 */
class Page extends \NGS\Patterns\AggregateRoot implements \IteratorAggregate
{
    protected $URI;
    protected $ID;
    protected $title;
    ...
    /**
     * Constructs object using a key-property array or instance of class "CMS\Page"
     *
     * @param array|void $data key-property array or instance of class "CMS\Page" or pass void to provide all fields with defaults
     */
    ...
    private function fromArray(array $data)
    {
        ...
        if (count($data) !== 0 && \NGS\Utils::WarningsAsErrors())
            throw new \InvalidArgumentException('Superflous array keys found in "CMS\Page" constructor: '.implode(', ', array_keys($data)));
    }
...
// ============================================================================
    ...
    public function __get($name)
    {
        ...
        throw new \InvalidArgumentException('Property "'.$name.'" in class "CMS\Page" does not exist and could not be retrieved!');
    }
...
// ============================================================================
    ...
    public function __set($name, $value)
    {
        if(in_array($name, self::$_read_only_properties, true))
            throw new \LogicException('Property "'.$name.'" in "CMS\Page" cannot be set, because it is read-only!');
        if ($name === 'title')
        ...
        throw new \InvalidArgumentException('Property "'.$name.'" in class "CMS\Page" does not exist and could not be set!');
    }
    ...
    /**
     * Create or update CMS\Page instance (server call)
     *
    ...
    private function updateWithAnother(\CMS\Page $result)
    {
        $this->URI = $result->URI;
    ...
    {
        return \CMS\PageJsonConverter::toJson($this);
    }

    public static function fromJson($item)
    {
        return \CMS\PageJsonConverter::fromJson($item);
    }

    public function __toString()
    {
        return 'CMS\Page'.$this->toJson();
    }

    public function __clone()
    {
        return \CMS\PageArrayConverter::fromArray(\CMS\PageArrayConverter::toArray($this));
    }

    public function toArray()
    {
        return \CMS\PageArrayConverter::toArray($this);
    }
    ...
    {
        return new \ArrayIterator(\CMS\PageArrayConverter::toArray($this));
    }
}