...
class Customer extends \NGS\Patterns\AggregateRoot implements \IteratorAggregate
{
    ...
    /**
     * Constructs object using a key-property array or instance of class "Shop\Customer"
     *
     * @param array|void $data key-property array or instance of class "Shop\Customer" or pass void to provide all fields with defaults
     */
    ...
    private function fromArray(array $data)
    {
        ...
        if (count($data) !== 0 && \NGS\Utils::WarningsAsErrors())
            throw new \InvalidArgumentException('Superflous array keys found in "Shop\Customer" constructor: '.implode(', ', array_keys($data)));
    }
...
// ============================================================================
    ...
    public function __get($name)
    {
        ...
        throw new \InvalidArgumentException('Property "'.$name.'" in class "Shop\Customer" does not exist and could not be retrieved!');
    }
...
// ============================================================================
    ...
    public function __set($name, $value)
    {
        if(in_array($name, self::$_read_only_properties, true))
            throw new \LogicException('Property "'.$name.'" in "Shop\Customer" cannot be set, because it is read-only!');
        if ($name === 'name')
            return $this->setName($value); // a string
        throw new \InvalidArgumentException('Property "'.$name.'" in class "Shop\Customer" does not exist and could not be set!');
    }
    ...
    /**
     * Create or update Shop\Customer instance (server call)
     *
    ...
    private function updateWithAnother(\Shop\Customer $result)
    {
        $this->URI = $result->URI;
    ...
    {
        return \Shop\CustomerJsonConverter::toJson($this);
    }

    public static function fromJson($item)
    {
        return \Shop\CustomerJsonConverter::fromJson($item);
    }

    public function __toString()
    {
        return 'Shop\Customer'.$this->toJson();
    }

    public function __clone()
    {
        return \Shop\CustomerArrayConverter::fromArray(\Shop\CustomerArrayConverter::toArray($this));
    }

    public function toArray()
    {
        return \Shop\CustomerArrayConverter::toArray($this);
    }
    ...
    {
        return new \ArrayIterator(\Shop\CustomerArrayConverter::toArray($this));
    }
}