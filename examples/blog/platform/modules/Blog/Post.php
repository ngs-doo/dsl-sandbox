 ...
 * @property array $modifiedOn an array of timestamps with time zones
 * @property array $keywords an array of strings
 ...
 * @property array $links an array of objects of class "Blog\Link"
 *
 * @package Blog
 * @version 0.9.9 beta
 */
class Post extends \NGS\Patterns\AggregateRoot implements \IteratorAggregate
{
    ...
    private static function provideDefaults(array &$data)
    {
        ...
        if(!array_key_exists('tags', $data))
            $data['tags'] = array(); // an array of strings
        if(!array_key_exists('modifiedOn', $data))
            $data['modifiedOn'] = array(); // an array of timestamps with time zones
        if(!array_key_exists('keywords', $data))
            $data['keywords'] = array(); // an array of strings
        if(!array_key_exists('links', $data))
            $data['links'] = array(); // an array of objects of class "Blog\Link"
    }
    ...
    private function fromArray(array $data)
    {
        ...
        unset($data['tags']);
        if (array_key_exists('modifiedOn', $data))
            $this->setModifiedOn($data['modifiedOn']);
        unset($data['modifiedOn']);
        if (array_key_exists('keywords', $data))
...
// ============================================================================
    ...
    /**
     * @return an array of timestamps with time zones
     */
    ...
    /**
     * @return an array of objects of class "Blog\Link"
     */
    ...
    public function __get($name)
    {
        ...
        if ($name === 'tags')
            return $this->getTags(); // an array of strings
        if ($name === 'modifiedOn')
            return $this->getModifiedOn(); // an array of timestamps with time zones
        if ($name === 'keywords')
            return $this->getKeywords(); // an array of strings
        if ($name === 'comments')
        ...
        if ($name === 'links')
            return $this->getLinks(); // an array of objects of class "Blog\Link"
...
// ============================================================================
    ...
    public function __isset($name)
    {
        ...
        if ($name === 'modifiedOn')
            return true; // an array of timestamps with time zones (always set)
        if ($name === 'keywords')
            return true; // an array of strings (always set)
        if ($name === 'comments')
        ...
        if ($name === 'links')
            return true; // an array of objects of class "Blog\Link" (always set)

        return false;
    }

    private static $_read_only_properties = array('URI', 'ID', 'categoriesURI');
    ...
    /**
     * @param array $value an array of timestamps with time zones
     *
     * @return array
     */
    ...
    {
        if ($value === null)
            throw new \InvalidArgumentException('Property "modifiedOn" cannot be set to null because it is non-nullable!');
        $value = \NGS\Timestamp::toArray($value, false);
    ...
    {
        if ($value === null)
            throw new \InvalidArgumentException('Property "keywords" cannot be set to null because it is non-nullable!');
        $value = \NGS\Converter\PrimitiveConverter::toStringArray($value, false);
        $this->keywords = $value;
        return $value;
    }
    ...
    /**
     * @param array $value an array of objects of class "Blog\Link"
     *
     * @return array
     */
    ...
    {
        if ($value === null)
            throw new \InvalidArgumentException('Property "links" cannot be set to null because it is non-nullable!');
        $value = \Blog\LinkArrayConverter::fromArrayList($value, true);
        $this->links = $value;
        return $value;
    }
    ...
    public function __set($name, $value)
    {
        ...
        if ($name === 'tags')
            return $this->setTags($value); // an array of strings
        if ($name === 'modifiedOn')
            return $this->setModifiedOn($value); // an array of timestamps with time zones
        if ($name === 'keywords')
            return $this->setKeywords($value); // an array of strings
        if ($name === 'comments')
        ...
        if ($name === 'links')
            return $this->setLinks($value); // an array of objects of class "Blog\Link"
    ...
    public function __unset($name)
    {
        ...
        if ($name === 'tags')
            throw new \LogicException('The property "tags" cannot be unset because it is non-nullable!'); // an array of strings (cannot be unset)
        if ($name === 'modifiedOn')
            throw new \LogicException('The property "modifiedOn" cannot be unset because it is non-nullable!'); // an array of timestamps with time zones (cannot be unset)
        if ($name === 'keywords')
            throw new \LogicException('The property "keywords" cannot be unset because it is non-nullable!'); // an array of strings (cannot be unset)
        if ($name === 'comments')
        ...
        if ($name === 'links')
            throw new \LogicException('The property "links" cannot be unset because it is non-nullable!'); // references to an array of objects of class "Blog\Link" (cannot be unset)
    }
