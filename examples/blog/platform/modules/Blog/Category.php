...
require_once __DIR__.'/CategoryJsonConverter.php';
 ...
 * @version 0.9.9 beta
 */
class Category extends \NGS\Patterns\AggregateRoot implements \IteratorAggregate
{
    protected $URI;
    protected $ID;
    protected $title;
    ...
    /**
     * Constructs object using a key-property array or instance of class "Blog\Category"
     *
     * @param array|void $data key-property array or instance of class "Blog\Category" or pass void to provide all fields with defaults
     */
    ...
    private function fromArray(array $data)
    {
        ...
        if (count($data) !== 0 && \NGS\Utils::WarningsAsErrors())
            throw new \InvalidArgumentException('Superflous array keys found in "Blog\Category" constructor: '.implode(', ', array_keys($data)));
    }
...
// ============================================================================
    ...
    public function __get($name)
    {
        ...
        throw new \InvalidArgumentException('Property "'.$name.'" in class "Blog\Category" does not exist and could not be retrieved!');
    }
...
// ============================================================================
    ...
    public function __set($name, $value)
    {
        if(in_array($name, self::$_read_only_properties, true))
            throw new \LogicException('Property "'.$name.'" in "Blog\Category" cannot be set, because it is read-only!');
        if ($name === 'title')
            return $this->setTitle($value); // a string
        throw new \InvalidArgumentException('Property "'.$name.'" in class "Blog\Category" does not exist and could not be set!');
    }
    ...
    /**
     * Create or update Blog\Category instance (server call)
     *
    ...
    private function updateWithAnother(\Blog\Category $result)
    {
        $this->URI = $result->URI;
    ...
    {
        return \Blog\CategoryJsonConverter::toJson($this);
    }

    public static function fromJson($item)
    {
        return \Blog\CategoryJsonConverter::fromJson($item);
    }

    public function __toString()
    {
        return 'Blog\Category'.$this->toJson();
    }

    public function __clone()
    {
        return \Blog\CategoryArrayConverter::fromArray(\Blog\CategoryArrayConverter::toArray($this));
    }

    public function toArray()
    {
        return \Blog\CategoryArrayConverter::toArray($this);
    }
    ...
    {
        return new \ArrayIterator(\Blog\CategoryArrayConverter::toArray($this));
    }
}