...
require_once __DIR__.'/CompanyJsonConverter.php';
 ...
 * @version 0.9.9 beta
 */
class Company extends \NGS\Patterns\AggregateRoot implements \IteratorAggregate
{
    protected $URI;
    protected $ID;
    protected $name;
    ...
    /**
     * Constructs object using a key-property array or instance of class "Park\Company"
     *
     * @param array|void $data key-property array or instance of class "Park\Company" or pass void to provide all fields with defaults
     */
    ...
    private function fromArray(array $data)
    {
        ...
        if (count($data) !== 0 && \NGS\Utils::WarningsAsErrors())
            throw new \InvalidArgumentException('Superflous array keys found in "Park\Company" constructor: '.implode(', ', array_keys($data)));
    }
...
// ============================================================================
    ...
    public function __get($name)
    {
        ...
        throw new \InvalidArgumentException('Property "'.$name.'" in class "Park\Company" does not exist and could not be retrieved!');
    }
...
// ============================================================================
    ...
    public function __set($name, $value)
    {
        if(in_array($name, self::$_read_only_properties, true))
            throw new \LogicException('Property "'.$name.'" in "Park\Company" cannot be set, because it is read-only!');
        if ($name === 'name')
            return $this->setName($value); // a string
        throw new \InvalidArgumentException('Property "'.$name.'" in class "Park\Company" does not exist and could not be set!');
    }
    ...
    /**
     * Create or update Park\Company instance (server call)
     *
    ...
    private function updateWithAnother(\Park\Company $result)
    {
        $this->URI = $result->URI;
    ...
    {
        return \Park\CompanyJsonConverter::toJson($this);
    }

    public static function fromJson($item)
    {
        return \Park\CompanyJsonConverter::fromJson($item);
    }

    public function __toString()
    {
        return 'Park\Company'.$this->toJson();
    }

    public function __clone()
    {
        return \Park\CompanyArrayConverter::fromArray(\Park\CompanyArrayConverter::toArray($this));
    }

    public function toArray()
    {
        return \Park\CompanyArrayConverter::toArray($this);
    }
    ...
    {
        return new \ArrayIterator(\Park\CompanyArrayConverter::toArray($this));
    }
}