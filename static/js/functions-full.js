...
var NGS_reload, moveFooter, msie;

window.message_builder = function(parent_dom, title, content, status, params) {
  var auto_close, auto_show, close_btn, close_timeout, is_closable, message_content, message_dom, message_id, message_status, message_title, _ref, _ref1, _ref2, _ref3;
  if (!(parent_dom != null)) {
    return false;
  }
  ...
  message_id = 'message_' + Math.floor(Math.random() * 101) + Math.floor(Math.random() * 101);
  message_title = title != null ? title : 'Message.';
  message_content = content != null ? content : 'Lorem ipsum dolor sit amet.';
  message_status = status != null ? status : '';
  if (!(params != null)) {
    is_closable = false;
    auto_close = false;
    auto_show = true;
  } else {
    is_closable = (_ref = params.isClosable) != null ? _ref : false;
    auto_close = (_ref1 = params.autoClose) != null ? _ref1 : false;
    close_timeout = (_ref2 = params.closeTimeout) != null ? _ref2 : 3000;
    auto_show = (_ref3 = params.autoShow) != null ? _ref3 : true;
  }
  close_btn = is_closable === true ? '<a class="close" data-dismiss="alert" href="#">&times;</a>' : '';
  message_dom = "<div id=\"" + message_id + "\" class=\"alert alert-" + message_status + " hide\">\n    " + close_btn + "\n    <strong class=\"js-status\">" + message_title + "</strong> <span class=\"js-content\">" + message_content + "</span>\n</div>";
  $(parent_dom).eq(0).prepend(message_dom);
  $('#' + message_id).alert();
  if (auto_show) {
    $('#' + message_id).show();
  }
  if (auto_close !== false) {
    setTimeout("$('#" + message_id + "').alert('close')", close_timeout);
  }
  return '#' + message_id;
};

window.modal_builder = function(title, content, callback, params) {
  var modal_auto_show, modal_callback, modal_cancel, modal_cancel_btn, modal_cancel_exists, modal_cancel_koBind, modal_cancel_type, modal_close_cross, modal_confirm, modal_confirm_koBind, modal_confirm_type, modal_content, modal_dom, modal_id, modal_title, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
  if ($('.container').length < 1) {
    return false;
  }
  modal_id = 'modal_' + Math.floor(Math.random() * 101) + Math.floor(Math.random() * 101);
  modal_title = title != null ? title : 'Prompt';
  modal_content = content != null ? content : 'Are you sure?';
  modal_callback = callback != null ? callback : function() {};
  if (!params) {
    modal_confirm = 'Save';
    modal_cancel = 'Cancel';
    modal_confirm_type = 'btn-primary';
    modal_cancel_type = '';
    modal_cancel_exists = true;
    modal_confirm_koBind = '';
    modal_cancel_koBind = '';
    modal_auto_show = false;
  } else {
    modal_confirm = (_ref = params.confirmTitle) != null ? _ref : 'Save';
    modal_cancel = (_ref1 = params.cancelTitle) != null ? _ref1 : 'Cancel';
    modal_confirm_type = (_ref2 = params.confirmType) != null ? _ref2 : 'btn-primary';
    modal_cancel_type = (_ref3 = params.cancelType) != null ? _ref3 : '';
    modal_cancel_exists = (_ref4 = params.cancelExists) != null ? _ref4 : true;
    modal_confirm_koBind = (_ref5 = params.confirm_koBind) != null ? _ref5 : '';
    modal_cancel_koBind = (_ref6 = params.cancel_koBind) != null ? _ref6 : '';
    modal_auto_show = (_ref7 = params.autoShow) != null ? _ref7 : false;
  }
  if (modal_cancel_exists) {
    modal_cancel_btn = "<button type=\"button\" class=\"btn " + modal_cancel_type + "\" data-dismiss=\"modal\" data-bind=\"" + modal_cancel_koBind + "\">" + modal_cancel + "</button>";
    modal_close_cross = '<a class="close" data-dismiss="modal">&times;</a>';
  } else {
    modal_cancel_btn = '';
    modal_close_cross = '';
  }
  modal_dom = "<div id=\"" + modal_id + "\" class=\"modal fade keyboard hide\">\n  <div class=\"modal-header\">\n    " + modal_close_cross + "\n    <h3>" + modal_title + "</h3>\n  </div>\n  <div class=\"modal-body\">\n    <p>" + modal_content + "</p>\n  </div>\n  <div class=\"modal-footer\">\n    <button type=\"button\" class=\"btn " + modal_confirm_type + "\" data-submit=\"modal\" data-bind=\"" + modal_confirm_koBind + "\">" + modal_confirm + "</button>\n    " + modal_cancel_btn + "\n  </div>\n</div>";
  $('.container').eq(0).append(modal_dom);
  $('#' + modal_id + ' [data-submit="modal"]').click(function() {
...
window.alert_builder = function(title, content) {
  var a_id;
  a_id = window.modal_builder(title, content, function() {}, {
    confirmTitle: 'Ok',
    cancelExists: false
  });
  return a_id;
...
$(function() {
  ...
  $(".slider-circle").popover({
    trigger: "hover"
  });
  if (navigator.appName !== "Opera") {
    $(".slider-circle").hover((function() {
      $(".slider-circle").stop().animate({
        opacity: 0.2
      }, 150);
      $(this).stop().animate({
        opacity: 1
      ...
      $(".slider-container").stop().animate({
        boxShadow: "0px 0px 120px 50px rgba(0,0,0,0.05)"
      }, 100);
      return $(".slider-circle").popover({
        trigger: "hover"
      });
    }), function() {
      $(".slider-circle").stop().animate({
      ...
      return $(".slider-container").stop().animate({
        boxShadow: "none"
      }, 100);
    });
  }
...
$(function() {
  var History, current, removeActiveSidebar, setActiveSidebar, setBody, setHistory, showDoc, updateActiveSidebar;
  if (document.location.hostname.match(/docs[^\.]*\.dsl-platform\.com/)) {
    ...
    setHistory = function(href) {
      var link, title;
      link = $("#sidebar a[class='" + href + "']");
      title = 'DSL Platform: ' + link.text();
      History.pushState({
        href: href
      }, title, href);
    };
    History.Adapter.bind(window, 'statechange', function() {
      var href;
      href = History.getState().data.href;
      showDoc(href);
    });
    showDoc = function(href) {
      updateActiveSidebar(href);
      setBody(href);
    };
    updateActiveSidebar = function(href) {
      removeActiveSidebar();
      setActiveSidebar(href);
    };
    removeActiveSidebar = function() {
      $('#sidebar em').remove();
      $('#sidebar .active').removeClass('active');
    };
    setActiveSidebar = function(href) {
      var link;
      link = $("#sidebar a[class='" + href + "']");
      link.parent().addClass('active');
      link.append('<em class="icon-chevron-right icon-white pull-right"></em>');
    };
    current = '';
    setBody = function(href) {
      current = href;
      $.get("" + href + ".html", function(body) {
        if (current === href) {
          $('.docs-content').html(body);
          moveFooter();
        }
      });
    };
...
window.RegisterModel = function() {
  this.email = ko.observable($('#register-email').val());
  this.isEmailOk = function() {
    if (typeof this.email() !== 'undefined') {
      return this.email().match(/.+@.{3,}/g) !== null;
    }
    return false;
  };
  this.isEmailError = function() {
    if (typeof this.email() === 'undefined') {
      return false;
    } else {
...
window.LoginModel = function() {
  this.email = ko.observable($('#login-email').val());
  ...
  this.isAllOk = function() {
    return this.isEmailOk() && this.isPasswordOk();
  };
  this.passwordRecovery = function() {
    document.location = '/profile/lost-password/' + encodeURIComponent(this.email());
  };
};

window.register = new RegisterModel();

window.login = new LoginModel();

$(function() {
  if ($('#register').length !== 0) {
    ko.applyBindings(register, $('#register')[0]);
  }
  if ($('#login').length !== 0) {
    ko.applyBindings(login, $('#login')[0]);
  }
});

window.findUpload = function(filename) {
  var out;
  out = false;
  $('.qq-upload-file').each(function(e) {
...
window.createUploader = function(uploadTarget) {
  var _this = this;
  window.uploader = new qq.FileUploader({
    ...
    template: "<div class=\"qq-uploader prepend-half\">\n  <div class=\"qq-upload-drop-area\"><h2 class=\"book\">{dragText}</h2></div>\n  <div class=\"qq-upload-button btn btn-success\">{uploadButtonText}</div>\n  <hr>\n  <ul class=\"qq-upload-list unstyled prepend-half\"></ul>\n</div>",
    onComplete: function(id, filename, response) {
      var filesList, msgBox, projectName;
      if (!response.success) {
        msgBox = message_builder('#uploads', 'Upload failed.', response.error || 'An error has occurred.', 'error', {
          isClosable: true,
          autoShow: true
        });
      } else {
        ...
        projectName = filesList.attr('data-project-name');
        filesList.prepend("<li class=\"file\">\n  <i class=\"icon-file\"></i>\n  <a href=\"/project/" + projectName + "/download/" + filename + "\">" + filename + "</a>\n  <a href=\"/project/" + projectName + "/uploads/delete/" + filename + "\" class=\"btn btn-small btn-danger pull-right js-remove-upload\" title=\"Remove file\"><i class=\"icon-trash icon-white\"></i></a>\n</li>");
        msgBox = message_builder('#uploads', 'Success!', 'File ' + filename + ' uploaded.', 'success', {
          isClosable: true,
          autoClose: true,
          closeTimeout: 2000,
          autoShow: true
...
$(function() {
  $('.js-action-delete').click(function(event) {
    var modal,
      _this = this;
    event.preventDefault();
    modal = modal_builder('Delete a project', 'Are you really sure you want to delete this project?<br>', function() {
      $.post($(_this).attr('href'), null, function(response) {
        var msgBox;
        if (response.success) {
          $(this).closest('li').hide();
          return document.location.reload();
        } else {
          return msgBox = message_builder('#projects', 'Failed to delete project', response.error || 'An error has occurred.', 'error', {
            isClosable: true,
            autoShow: true
          });
        }
  ...
  $('.js-action-undelete').click(function(event) {
    var modal,
      _this = this;
    event.preventDefault();
    modal = modal_builder('Undelete a project', 'Are you really sure you want to undelete this project?', function() {
      $(_this.form).submit();
      $.post($(_this).attr('href'), null, function(response) {
        var msgBox;
        if (response.success) {
          ...
          return msgBox = message_builder('#projects', 'Failed to restore project', response.error || 'An error has occurred.', 'error', {
            isClosable: true,
            autoShow: true
          });
        }
  ...
  return $('.js-remove-upload').click(function() {
    var url,
      _this = this;
    url = $(this).attr('href');
    $.get(url, function(res) {
      ...
      if (res.ok) {
        ...
        return msgBox = message_builder('#uploads', 'Failed to restore project', response.error || 'An error has occurred.', 'error', {
          isClosable: true,
          autoShow: true
        });
      }
